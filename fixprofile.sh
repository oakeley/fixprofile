...
python2 ~/myopenaps/nightscout/get_profile.py --nightscout https://oakeley.herokuapp.com display --format openaps --name 'OpenAPS Autosync' | awk -v go="True" '{ if(go=="True") {print $0; if(length($0)==7) {go="False"} } }' >> new.json
